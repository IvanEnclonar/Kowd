...
function Exercises({open, setOpen}){
    return(
...
function MC(){
    return(
        <div className="Exercise__MCDiv">
            <div className="Exercise__MCItem">Peaches</div>
            <div className="Exercise__MCItem">Bananas</div>
            <div className="Exercise__MCItemWrong">Strawberries</div>
            <div className="Exercise__MCItemCorrect">Oranges</div>       
        </div>
    );
}
